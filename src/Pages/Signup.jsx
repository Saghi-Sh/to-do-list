        ...
        <div className="flex-1 flex flex-col justify-center p-12 sm:px-10 md:px-8 lg:px-12 space-y-6 mx-auto max-w-md w-full">
          ...
          <div className="relative">
            <input
              ...
              className="border border-gray-300 rounded-lg p-3 pr-10 focus:outline-none focus:ring-2 focus:ring-purple-400 w-full"
            />
            <button
              type="button"
          ...
          <button className="bg-Taupe text-white py-3 rounded-lg font-medium hover:bg-lightTaupe transition">
            Sign Up
          </button>
